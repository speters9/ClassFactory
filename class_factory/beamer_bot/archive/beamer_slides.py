...
from class_factory.utils.slide_pipeline_utils import clean_latex_content
...
class BeamerSlides(BaseModel):
    slides: List[Slide] = Field(description="A list of Slide objects representing the presentation slides")
